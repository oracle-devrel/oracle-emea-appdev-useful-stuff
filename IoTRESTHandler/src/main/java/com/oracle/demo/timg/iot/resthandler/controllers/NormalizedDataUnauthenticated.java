...
@Singleton
public class NormalizedDataUnauthenticated {
	...
	public String postNormalizedDataAsJson(@PathVariable("digitaltwinid") String digitaltwinid,
		...
		String resp = "NormalizedDataUnauthenticated Received json request for digitaltwinid=" + digitaltwinid
	...
	public String postNormalizedDataAsString(@PathVariable("digitaltwinid") String digitaltwinid,
			@PathVariable("contentpath") String contentpath, @PathVariable("timestamp") String timestamp,
			@Body String content) {
		String resp = "NormalizedDataUnauthenticated Received string request for digitaltwinid=" + digitaltwinid
	...
	public String postNormalizedDataAsBase64(@PathVariable("digitaltwinid") String digitaltwinid,
		...
		String resp = "NormalizedDataUnauthenticated Received base64 request for digitaltwinid=" + digitaltwinid
