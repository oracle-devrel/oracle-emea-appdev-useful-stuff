...
echo
echo "To send the digital twin small models test data for the configuration using https for device $DIGITAL_TWIN_INSTANCE_DEVICE_NAME"
...
echo "To send digital twin small test data for the status for device $DIGITAL_TWIN_INSTANCE_DEVICE_NAME"
echo 'export CURRENT_TS=`date +%s%N | cut -b1-13`'
...
echo
echo "To send digital twin small test data for the configuration using mqttx for device $DIGITAL_TWIN_INSTANCE_DEVICE_NAME"
echo 'export CURRENT_TS=`date +%s%N | cut -b1-13`'
...
echo
echo "To get the most recent normalized data for device $DIGITAL_TWIN_INSTANCE_DEVICE_NAME"
