...
echo "To send test data for the configuration using https for device $DIGITAL_TWIN_INSTANCE_DEVICE_NAME"
...
echo "To send text data for the status for device $DIGITAL_TWIN_INSTANCE_DEVICE_NAME"
echo 'export CURRENT_TS=`date +%s%N | cut -b1-13`'
...
echo "To send test data for the configuration using mqttx for device $DIGITAL_TWIN_INSTANCE_DEVICE_NAME"
echo 'export CURRENT_TS=`date +%s%N | cut -b1-13`'
