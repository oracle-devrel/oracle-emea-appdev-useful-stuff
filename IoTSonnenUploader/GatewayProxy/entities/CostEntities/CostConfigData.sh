...
# DTMI.json)
export ENTITY_MODEL_NAME=HACostModel
...
export ENTITY_ADAPTER_NAME=HACostdapter
...
export ENTITY_ENDPOINT_NAME=cost
...
# for each instance
export ENTITY_SAMPLE_DATA="{\\\"cost\\\": 2.15, \\\"timestamp\\\": \\\"\$CURRENT_TS\\\"}"