...
# DTMI.json)
export ENTITY_MODEL_NAME=HAOccupancy
...
export ENTITY_ADAPTER_NAME=HAOccupancyAdapter
...
export ENTITY_ENDPOINT_NAME=occupancy
...
# for each instance
export ENTITY_SAMPLE_DATA="{\\\"occupancy\\\": true, \\\"timestamp\\\": \\\"\$CURRENT_TS\\\"}"