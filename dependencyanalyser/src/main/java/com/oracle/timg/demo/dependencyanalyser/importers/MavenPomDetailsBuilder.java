...
public interface MavenPomDetailsBuilder {

	public default IdentifiedJarVersion buildIdentifiedJarVersion(String groupId, String artifactId, String version) {
	...
	public default IdentifiedJarVersion buildIdentifiedJarVersion(String groupId, String artifactId, String version,
		...
		IdentifiedJarVersion identifiedJarVersion = new IdentifiedJarVersion(version, identifiedJarFile,
				scope.toString(), scope);
		return identifiedJarVersion;
	}
}
