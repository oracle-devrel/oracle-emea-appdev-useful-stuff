...
@Log
@Singleton
public class IdentityProcessorDetails {
	private final AuthenticationProcessor authProcessor;
	@Getter
	private final IdentityProcessor identityProcessor;

	@Inject
	public IdentityProcessorDetails(AuthenticationProcessorDetails authenticationProcessorDetails)
			throws IllegalArgumentException, IOException {
		this.authProcessor = authenticationProcessorDetails.getAuthenticationProcessor();
		this.identityProcessor = new IdentityProcessor(authProcessor);
	}
