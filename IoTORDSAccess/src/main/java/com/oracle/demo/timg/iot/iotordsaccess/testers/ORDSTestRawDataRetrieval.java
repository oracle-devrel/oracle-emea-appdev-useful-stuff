...
@Log
@Singleton
@Requires(property = "iot.ords.test-rawdata-retrieval", value = "true", defaultValue = "false")
public class ORDSTestRawDataRetrieval {
	...
	public void testGetRawData() {
		...
		RawDataResponse data = ordsApiClient.getRawData(0, 2);
